...
---@field getIndex fun(self: Nyoom.Grid, position: Nyoom.Vector2): integer? Returns the index in the map that correlates to the given position, or nil if out of bounds.
...
---@field getValue fun(self: Nyoom.Grid, position: Nyoom.Vector2): any Returns a value mapped to given position, or nil if out of bounds.
---@field getValue fun(self: Nyoom.Grid, index: integer): any Returns a value mapped to a given index, or nil if out of bounds.
---@field setValue fun(self: Nyoom.Grid, value: any, x: integer, y: integer): Nyoom.Grid Sets a value mapped to given position. Can be chained.
---@field setValue fun(self: Nyoom.Grid, value: any, position: Nyoom.Vector2): Nyoom.Grid Sets a value mapped to given position. Can be chained.
